...
const PLACES: readonly {
  ...
  },
  {
    ...
    href: '/catalog',
    where: 'Над фильтрами',
    hint: 'Тонкая плашка. На слот — 1 баннер (ротация по весу, не все сразу).',
  },
  {
    id: 'catalog_sidebar',
    page: 'Каталог',
    ...
    hint: 'Узкая колонка на широком экране. Показывается 1 баннер; при 50 дилерах — ротация, не стена из 50.',
  },
  {
    id: 'car_page',
    page: 'Карточка лота',
    ...
    hint: 'Компактный блок у цены. На слот — 1 баннер.',
  },
];
    ...
    <div className="flex flex-col gap-8">
      ...
      <PageGuide
        items={[
          ...
          {
            title: 'Ротация',
            text: 'В каждом слоте на сайте виден 1 баннер (реже 1–2). Если активных много — показывается с большим весом, остальные крутятся, стеной не встают.',
          },
        ]}
      />
