...
const STAGES = [
  { n: '01', title: 'Лид', text: 'Заявка принята. Дилер связывается и уточняет, что именно нужно.' },
  { n: '02', title: 'Потребность', text: 'Согласовываются рынок, бюджет, кузов и сроки. Можно привязать лот из каталога.' },
  { n: '03', title: 'Договор', text: 'Фиксируются цена, состав услуг и ответственность сторон.' },
  { n: '04', title: 'Оплата', text: 'Задаток или полная сумма. Платёжные документы лежат в карточке сделки.' },
  { n: '05', title: 'Привоз', text: 'Выкуп у продавца, отгрузка и путь до порта назначения.' },
  { n: '06', title: 'Растаможка', text: 'Декларация, пошлины, СБКТС. Сроки этапа видны клиенту.' },
  { n: '07', title: 'Выдача', text: 'Автомобиль передаётся, сделка закрывается, можно оставить отзыв.' },
] as const;
